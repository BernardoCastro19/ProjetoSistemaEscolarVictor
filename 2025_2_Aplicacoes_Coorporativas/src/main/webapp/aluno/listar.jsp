...
<body>
    ...
    <table>
        ...
        <tr>
            <td><%= aluno.getId() %></td>
            <td><%= aluno.getNome() %></td>
            <td><%= aluno.getDocumento() %></td>
            <td>
                <a href="<%= request.getContextPath() %>/aluno?acao=buscar&id=<%= aluno.getId() %>">Editar</a>
            </td>
            <td>
                <a href="<%= request.getContextPath() %>/aluno?acao=deletar&id=<%= aluno.getId() %>"
